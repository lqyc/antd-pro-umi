...
function BaseForm(props) {
  ...
  var transformKey = function transformKey(values, omit) {
    return (0, _proUtils.transformKeySubmitValue)((0, _proUtils.conversionSubmitValue)(values, dateFormatter, fieldsValueType.current, omit), transformKeyRef.current);
  };
  /** 渲染提交按钮与重置按钮 */
