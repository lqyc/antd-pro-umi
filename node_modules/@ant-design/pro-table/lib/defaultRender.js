...
function defaultRenderText(config) {
  ...
  return /*#__PURE__*/_react.default.createElement(_form.default.Item, {
    ...
    var formItemProps = (0, _proUtils.getFieldPropsOrFormItemProps)(columnProps === null || columnProps === void 0 ? void 0 : columnProps.formItemProps, form, _objectSpread(_objectSpread({
    ...
    var inputDom = /*#__PURE__*/_react.default.createElement(_proUtils.InlineErrorFormItem, _extends({
      name: name
    }, formItemProps, {
      ...
      fieldProps: (0, _proUtils.getFieldPropsOrFormItemProps)(columnProps === null || columnProps === void 0 ? void 0 : columnProps.fieldProps, form, _objectSpread(_objectSpread({}, columnProps), {}, {
        rowKey: config.recordKey || config.index,
        rowIndex: config.index,
        isEditable: true
      }))
    ...
    if (columnProps === null || columnProps === void 0 ? void 0 : columnProps.renderFormItem) {
      ...
      return /*#__PURE__*/_react.default.createElement(_proUtils.InlineErrorFormItem, _extends({
