...
var formInputRender = function formInputRender(props, ref) {
  ...
  var formItemProps = (0, _proUtils.getFieldPropsOrFormItemProps)(propsFormItemProps, form, item);
  ...
  var _getFieldPropsOrFormI = (0, _proUtils.getFieldPropsOrFormItemProps)(item.fieldProps || {}, form, item),
  ...
  if (item.renderFormItem && form) {
    ...
    return /*#__PURE__*/_react.default.createElement(_proForm.ProFormField, _extends({}, rest, initialProps, {
      ref: ref,
  ...
  return /*#__PURE__*/_react.default.createElement(_proForm.ProFormField, _extends({
    ...
    isDefaultDom: true,
    valueEnum: (0, _proUtils.runFunction)(item.valueEnum, undefined),
    onChange: onChange,
    fieldProps: _objectSpread({
      style: {
        width: undefined
